...
export declare class CustomerResource extends IuguResouces<Customer> {
    ...
    createInvoice(customer_id: string, email: string, date: string, description: string, price: number, payer?: any, payable_with?: string, expired_url?: string): rp.RequestPromise;
}
